...
class WeatherViewModel: NSObject, ObservableObject, CLLocationManagerDelegate{
    ...
    //@Published private(set) var model: WeatherModel = WeatherModel(cities: ["Vienna","Warsaw","Buenos Aires","Berlin","London","Paris"])
    @Published private(set) var model: WeatherModel = WeatherModel(cities: ["1","551801","523920","468739","638242","44418","615702"])
